...
class SolCompiler(object):
    ...
    def extract_pragma(source_code: str) -> Union[str, None]:
        ...
        Strips leading whitespace before matching so that contracts
        whose pragma line has a leading space (e.g. " pragma solidity ^0.4.15;")
        are handled correctly — previously this returned None and caused
        a NoneType.strip() crash in install_solc_pragma_solc.
        '''
