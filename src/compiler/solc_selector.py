...
class SolcSelector(object):
    ...
    solidity_versions = ['v0.8.28', 'v0.8.27', 'v0.8.26', 'v0.8.25', 'v0.8.24', 'v0.8.23', 'v0.8.22', 'v0.8.21', 'v0.8.20','v0.8.14', 'v0.8.13', 'v0.8.12', 'v0.8.11', 'v0.8.10', 'v0.8.9', 'v0.8.8', 'v0.8.7', 'v0.8.6', 'v0.8.5', 'v0.8.4', 'v0.8.3', 'v0.8.2', 'v0.8.1', 'v0.8.0', 'v0.7.6', 'v0.7.5', 'v0.7.4', 'v0.7.3', 'v0.7.2', 'v0.7.1', 'v0.7.0', 'v0.6.12', 'v0.6.11', 'v0.6.10', 'v0.6.9', 'v0.6.8', 'v0.6.7', 'v0.6.6', 'v0.6.5', 'v0.6.4', 'v0.6.3', 'v0.6.2', 'v0.6.1',
    ...
    # Fallback map: latest patch for each minor version
    _PATCH_FALLBACK = {
        '0.4': 'v0.4.26',
        '0.5': 'v0.5.17',
        '0.6': 'v0.6.12',
    ...
    def install_solc_pragma_solc(self, version: str, install=True) -> str:
        ...
        # if everything fails, try falling back to the latest patch for the minor version
        # This handles pragmas like "pragma solidity 0.4.9;" where 0.4.9 is not in our list
        # but 0.4.26 would work fine.
        comparators_all = [m.groupdict()
                           for csr in comparator_set_range
                           for m in comparator_regex.finditer(csr)]
        if comparators_all:
            first = comparators_all[0]
            minor_key = f"{first['major']}.{first['minor']}"
            fallback = SolcSelector._PATCH_FALLBACK.get(minor_key)
            if fallback:
                SolcSelector._validate_version(fallback)
                if install:
