...
class VariableDeclaration(Node):
    ...
    def __init__(self, ast_node: dict,
        ...
        # register the variable in the CFG Metadata
        cfg_metadata.register_variable(
            self.name, self.typeDescriptions['typeString'])
        
        # Debugging print statements
        logging.debug(f"VariableDeclaration Node: name={self.name}, stateVariable={self.stateVariable}, value={self.value}, scope={self.scope}")
