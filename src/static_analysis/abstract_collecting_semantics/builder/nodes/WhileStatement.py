...
from static_analysis.abstract_collecting_semantics.builder.common import compute_expression_object, generate_undef_state, Bottom
...
def generate_exit_sets(node: WhileStatement, entry_set: apron.Abstract0, exit_sets: Dict[str, apron.Abstract0],
    ...
    if expr_value == 'any' or isinstance(expr_value, Bottom):
        ...
        print(f"[WhileStatement] Condition indeterminate ({type(expr_value).__name__}), "
